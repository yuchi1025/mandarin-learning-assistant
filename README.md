...
```bash
python3 scripts/validate_dictionary.py --expected-count 503
```
...
- `scripts/validate_dictionary.py` validates the 503-entry dictionary, required fields, consistent field order, duplicate words, examples, and tone-marked pinyin.
